...
class PreparedQuotationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = DB::table('precription_models')->where('id', $request->id)->update(array('confirm' => null));

        return redirect('prepared-quotation')->with('message', 'Quotation Status Added Successfully');
    }
