        ...
        <nav class="navbar navbar-expand navbar-light " style="background-color: #e3f2fd;">
            <div class="container-fluid font-weight-bold">
                <a href="#" class="navbar-brand d-lg-block ml-lg-5">
                    <span class="text-dark">PHARMACY ADMIN DASHBOARD</span>
                </a>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-2 bg-light border-right d-none d-lg-block" style="height: 100vh">
                ...
                <div class="row border-bottom mb-2 mt-4 bg-white">
                    <div class="col-12">
                        ...
                        <div class="text-center mt-2 mb-3">
                            <span class="h5 font-weight-bold"><span class="text-dark text-uppercase">Pharmacy</span>
                                <span class="text-danger">management</span></span>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <a href="{{ url('customers') }}" class="btn border-bottom col-12 text-left font-weight-bold"><i
                            class="fa fa-tachometer mr-2" aria-hidden="true"></i> Admins And Customers</a>

                        <a href="{{ url('precribtion-list') }}" class="btn border-bottom col-12 text-left font-weight-bold"><i
                                class="fa fa-tachometer mr-2" aria-hidden="true"></i> New Added Prescriptions</a>
                        <a href="{{ url('accept') }}" class="btn border-bottom col-12 text-left font-weight-bold"><i
                                class="fa fa-tachometer mr-2" aria-hidden="true"></i> Accept Prescriptions</a>
                        <a href="{{ url('reject') }}" class="btn border-bottom col-12 text-left font-weight-bold"><i
                                class="fa fa-tachometer mr-2" aria-hidden="true"></i> Reject Prescriptions</a>
                        <a href="{{ url('medicine-list') }}"
                            class="btn border-bottom col-12 text-left font-weight-bold"><i class="fa fa-tachometer mr-2"
                                aria-hidden="true"></i> Available Medicine List</a>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-10">
                ...
                <div class="col-12 p-3 bg-light mt-3 text-center font-style-italic">
                    <span class="text-muted">Copyright © 2023 Seshan Nethmika | All rights reserved.</span>
                </div>
            </div>
            <!-- End Right -->
        </div>
