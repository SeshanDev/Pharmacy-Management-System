        ...
        <nav class="navbar navbar-expand navbar-light " style="background-color: #e3f2fd;">
            <div class="container-fluid font-weight-bold">
                <a href="#" class="navbar-brand d-lg-block ml-lg-5">
                    <span class="text-dark">PHARMACY USER DASHBOARD</span>
                </a>   
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink"
                                ...
                                @if(Auth::user()->logo)
                                <img src="{{asset(Auth::user()->logo)}}" alt="profile"
                ...
                <div>
                    <div class="row bg-white mt-4">
                        ...
                        <a href="{{ url('upload-precribtion') }}"
                            class="btn border-bottom col-12 text-left font-weight-bold"><i class="fa fa-tachometer mr-2"
                                aria-hidden="true"></i> Add Precribtion</a>

                        <a href="{{ url('precribtion-history') }}"
                            class="btn border-bottom col-12 text-left font-weight-bold"><i class="fa fa-tachometer mr-2"
                                aria-hidden="true"></i> Recently Added Prescriptions</a>
                    </div>
                    ...
                    <div class="row border-bottom  bg-white border-top mt-4">
                        <a href="{{url('prepared-quotation')}}" class="btn border-bottom col-12 text-left font-weight-bold"><i
                                class="fa fa-tachometer mr-2" aria-hidden="true"></i> Prepared
                            Quotation</a>
                    </div>
                </div>
